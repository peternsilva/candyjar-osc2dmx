...
{
    { AREA_STANDUP_KIT, FIXTURE_ADJ_38B_7CH, 1 },   // Sharp beamer
    { AREA_STANDUP_KIT, FIXTURE_ADJ_H2O_3CH, 8 },

    { AREA_DRUM_RISERS, FIXTURE_RGB_STRIP_3CH, 11 },
    { AREA_DRUM_RISERS, FIXTURE_RGB_STRIP_3CH, 14 },
    { AREA_DRUM_RISERS, FIXTURE_RGB_STRIP_3CH, 17 },

    { AREA_DRUMS_OVERHEAD, FIXTURE_ADJ_38B_7CH, 20 },
    { AREA_DRUMS_OVERHEAD, FIXTURE_ADJ_38B_7CH, 27 },
    { AREA_DRUMS_OVERHEAD, FIXTURE_ADJ_38B_7CH, 34 },

    { AREA_HALFWALL, FIXTURE_ADJ_38B_7CH, 41 },
    { AREA_HALFWALL, FIXTURE_ADJ_38B_7CH, 48 },
    { AREA_HALFWALL, FIXTURE_ADJ_38B_7CH, 55 },

    { AREA_DJ_BOOTH, FIXTURE_ADJ_MEGA_PAR_7CH, 62 },

    // Lost MEGA PARs
    { AREA_DJ_BOOTH, FIXTURE_ADJ_MEGA_PAR_7CH, 69 },
    { AREA_DJ_BOOTH, FIXTURE_ADJ_MEGA_PAR_7CH, 76 },
    { AREA_DJ_BOOTH, FIXTURE_ADJ_MEGA_PAR_7CH, 83 },
};
